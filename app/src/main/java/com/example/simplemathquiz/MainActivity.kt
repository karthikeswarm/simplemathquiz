...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var cur_level : TextView
    ...
    private val questionsPerLevel = 5
    ...
    private fun startGame() {
        ...
        // currentLevel = 1Reset current level to 1 when starting the game
    ...
    private fun showNextQuestion() {
        ...
        updateQuestionUI()
        startTimer()
        questionNumberTextView.text = "    Question $currentQuestionNumber/20    "

        currentQuestionNumber++

        // Check if it's time to move to the next level
        if (currentQuestionNumber % questionsPerLevel == 0 && currentQuestionNumber != 0) {
